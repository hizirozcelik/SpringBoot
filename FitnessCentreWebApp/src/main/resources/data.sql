...
INSERT INTO Schedule (ScheduleDate, ScheduleTime, RoomId, ClassId, LocId)
    VALUES ('2021-12-12','09:50', 1, 1, 3);
INSERT INTO Schedule (ScheduleDate, ScheduleTime, RoomId, ClassId, LocId)
    VALUES ('2021-12-12','10:50', 3, 2, 1);
INSERT INTO Schedule (ScheduleDate, ScheduleTime, RoomId, ClassId, LocId)
    VALUES ('2021-12-12','10:20', 3, 1, 1);
INSERT INTO Schedule (ScheduleDate, ScheduleTime, RoomId, ClassId, LocId)
    VALUES ('2021-12-12','09:50', 2, 3, 1);
...
INSERT INTO Review (CoachId, userId, ReviewDate, ComScore, EnthScore, PunctScore, ReviewText)
    VALUES (1, 1, '2021-12-12', 3, 4, 3, 'Good coach');
INSERT INTO Review (CoachId, userId, ReviewDate, ComScore, EnthScore, PunctScore, ReviewText)
    VALUES (1, 2, '2021-11-12', 4, 5, 3, 'The best ever');
INSERT INTO Review (CoachId, userId, ReviewDate, ComScore, EnthScore, PunctScore)
    VALUES (3, 3, '2021-10-12', 4, 5, 3);
INSERT INTO Review (CoachId, userId, ReviewDate, ComScore, EnthScore, PunctScore)
    VALUES (2, 1, '2021-11-26', 3, 5, 5);
...
INSERT INTO userLocation (locId, userId, isHomeLoc, dayOfVisit)
    VALUES (1,1,1, '2021-12-02');
    
INSERT INTO userLocation (locId, userId, isHomeLoc, dayOfVisit)
    VALUES (1,1,1, '2021-12-03');
    
INSERT INTO userLocation (locId, userId, isHomeLoc, dayOfVisit)
    VALUES (1,1,1, '2021-12-04');
    
INSERT INTO userLocation (locId, userId, isHomeLoc, dayOfVisit)
    VALUES (2,1,0, '2021-12-05');
    
INSERT INTO userLocation (locId, userId, isHomeLoc, dayOfVisit)
    VALUES (1,2,0, '2021-12-26');
    
INSERT INTO userLocation (locId, userId, isHomeLoc, dayOfVisit)
    VALUES (1,1,1, '2021-12-02');
    
INSERT INTO userLocation (locId, userId, isHomeLoc, dayOfVisit)
    VALUES (1,2,0, '2021-12-10');
    
INSERT INTO userLocation (locId, userId, isHomeLoc, dayOfVisit)
    VALUES (2,2,1, '2021-12-04');
